# Guide for installing, setting up and building Zephyr using Xtensa toolchain
...
```
- Execute sample project (Single-core):
```
xt-run build/zephyr/zephyr.elf
```
- Generate xtsc subsystem (Multi-core):
```
...
-build build/subsys
```
- Execute sample project (Multi-core):
```
xtsc-run \
